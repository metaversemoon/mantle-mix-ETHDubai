...
import heroImage from '../public/img/top.png'

const Hero = () => {
  return (
    <section
      className="px-2 py-20 text-white"
      ...
      <div className="md:flex items-center justify-around">
        <div className=" md:w-3/5 px-5">
          <h2 className="font-bold text-4xl text-skin-base my-4 leading-tight lg:text-7xl tracking-tighter mb-6 lg:tracking-normal">
            ...
            <span
              className="text-4xl text-skin-base my-4 leading-tight lg:text-7xl tracking-tighter mb-6
            bg-gradient-to-r bg-clip-text text-transparent
            from-[#C41CFF] via-[#201CFF] to-purple-500
            animate-text"
            >
              Mantle, arbitrum, optimism & zksync.
            </span>
          </h2>
          <p className="sm:mt-10 text-base text-skin-muted dark:text-skin-darkMuted lg:text-2xl sm:mb-14 mb-10">
            Interact with your smart contracts with ease in a user-friendly
            interface, without the requirement of any technical knowledge with
            the zkSync-Chain now.


            eplit: the collaborative browser based IDE - Replit
