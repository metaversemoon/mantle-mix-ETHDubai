...
const ReturnedFunction = (props: any) => {
  ...
  const { data: signer } = props.signer
  ...
  return (
    <div className="flex flex-col justify-around w-[318px] h-[320px] pb-5 bg-gray-300 px-8 border-t-8 border-blue-400 rounded-lg my-10 mx-10 bg-gray-800 text-white">
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          className="bg-gradient-to-t from-[#201CFF] to-[#1c6fff] py-2 px-10 hover:bg-gradient-to-b from-[#201CFF] to-[#1c6fff] mb-5"
        >
          Submit
        </button>
